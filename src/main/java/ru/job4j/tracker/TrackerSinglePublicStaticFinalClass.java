...
public class TrackerSinglePublicStaticFinalClass {
    private final Item[] items = new Item[100];
    private int ids = 1;
    private int size = 0;

    private TrackerSinglePublicStaticFinalClass() {
    }

    public static TrackerSinglePublicStaticFinalClass getInstance() {
        return Holder.INSTANCE;
    }

    private static final class Holder {
        private static final TrackerSinglePublicStaticFinalClass INSTANCE = new TrackerSinglePublicStaticFinalClass();
    }
